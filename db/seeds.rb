...
r1 = Recipe.create(name: "Goulash soup", image: "goulash_soup_rnmb2g", food_category_id: f1.id, cooking_time: 20, preping_time: 20, servings: 4)
r2 = Recipe.create(name: "Potato soup", image: "potato_soup_u6b75y", food_category_id: f1.id, cooking_time: 20, preping_time: 20, servings: 4)
